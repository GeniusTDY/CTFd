...
def load(app):
    ...
    # (rendered by CTFd core) using the global _() function powered by
    # Flask-Babel translations. Must use register_admin_plugin_script so
    # the script is injected via get_registered_admin_scripts() in admin
    # base.html.
