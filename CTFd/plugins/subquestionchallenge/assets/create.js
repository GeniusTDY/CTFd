CTFd.plugin.run((_CTFd) => {
    ...
    // Translations are injected via Flask-Babel in create.html (block header)
    // into CTFd.translations. The __() function reads from there.
    ...
    // Initialize directly; translations already injected by create.html template
    initCreateForm();
});