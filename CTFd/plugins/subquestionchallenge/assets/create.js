CTFd.plugin.run((_CTFd) => {
    ...
    // CTFd.translations is populated by the server-rendered /i18n.js script
    // (registered via register_admin_plugin_script), so translations are
    // available immediately — no async fetch, no UI flicker.
