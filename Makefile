...
translations-extract:
	pybabel extract -F babel.cfg -k lazy_gettext -k _l -k safe_lazy_gettext -k gettext -k ngettext:1,2 -o messages.pot .

translations-update:
	pybabel update --ignore-obsolete -N -i messages.pot -d CTFd/translations
